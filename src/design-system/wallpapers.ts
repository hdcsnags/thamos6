...
export const WALLPAPERS: Wallpaper[] = [
  ...
  },
  {
    ...
    style: {
      backgroundColor: '#050508',
      backgroundImage: 'url(/wallpapers/dragon-circuit.png)',
  ...
  },
  {
    ...
    style: {
      backgroundColor: '#050508',
      backgroundImage: 'url(/wallpapers/dragon-warrior.png)',
      backgroundSize: 'cover',
      backgroundPosition: 'center',
      backgroundRepeat: 'no-repeat',
    },
    preview: 'radial-gradient(circle at 50% 50%, rgba(0,217,255,0.25), transparent 60%), #050508',
  },
  {
    id: 'dragon-aggressive',
    name: 'Aegis',
    style: {
      backgroundColor: '#050508',
      backgroundImage: 'url(/wallpapers/dragon-aggressive.jpg)',
      backgroundSize: 'cover',
      backgroundPosition: 'center',
      backgroundRepeat: 'no-repeat',
    },
