...
import { Code, Copy, Check, ArrowRightLeft, Trash2, AlertTriangle } from 'lucide-react';
...
const encodings: EncodingOption[] = [
  ...
  { id: 'url', name: 'URL Encoding', description: 'Percent-encoded characters' },
  { id: 'hex', name: 'Hexadecimal', description: 'Hex string (with or without 0x)' },
